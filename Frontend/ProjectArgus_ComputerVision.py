...
'''Added Sections (1-4) for clarity, because the file is a little long with ~180 lines of code.
...
try:
    ...
    while cap.isOpened():
        ...
        if len(human_results[0].boxes) > 0:
            ...
            banana_results = banana_sniper.predict(source=frame, conf=0.5, imgsz=320, verbose=False)
